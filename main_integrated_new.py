...
from competitive_intel_agent import CompetitiveIntelAgent, format_intel_report
...
class FedContractingAIIntegrated:
    ...
    def __init__(self, config_path: str = "config.yaml"):
        ...
        self.competitive_intel = CompetitiveIntelAgent()
    ...
    def _save_competitive_report(self, comp_intel: Dict[str, Any]):
        ...
        report = format_intel_report(comp_intel)
